  ...
  return (
    <>
      <div className="relative">
        <Input
          className="dark:bg-[#303030] bg-[#FAFAFA] h-full px-5 text-center rounded-full border-none dark:caret-[#edf2f4] placeholder-gray-500 shadow-[2px_2px_4px_rgba(0,0,0,0.15)] dark:shadow-none"
          type="text"
