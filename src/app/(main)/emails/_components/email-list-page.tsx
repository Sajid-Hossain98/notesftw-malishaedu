  ...
  return (
    <div>
      <div className="relative md:w-[40%] w-full md:ml-auto">
        ...
        <Input
          className="dark:bg-[#303030] bg-[#FAFAFA] rounded-[3px] border-none focus-visible:outline outline-[#edf2f4] focus-visible:outline-1 dark:placeholder:caret-[#edf2f4] placeholder-gray-500 shadow-[2px_2px_4px_rgba(0,0,0,0.15)] dark:shadow-none h-8 md:text-lg text-base placeholder:text-base md:placeholder:text-lg"
          type="text"
