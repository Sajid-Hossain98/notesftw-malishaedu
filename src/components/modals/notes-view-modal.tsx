        ...
        <DialogHeader className="text-start">
          <div>
            <div className="flex items-center justify-start gap-2 mt-3 md:gap-4">
              ...
              <div>
                <DialogTitle className="text-lg dark:text-zinc-300 sm:text-3xl md:pb-2">
                  {note?.title}
                </DialogTitle>

                <div className="flex items-center gap-2">
                  <DialogDescription className="flex items-center gap-1 text-sm font-semibold sm:gap-2 dark:text-zinc-300 sm:text-xl">
                    <School className="w-3.5 h-3.5 md:w-5 md:h-5" />

                    {note?.university?.universityShortName}
                  </DialogDescription>
                  -
                  <DialogDescription className="text-sm font-semibold capitalize dark:text-zinc-300 sm:text-xl line-clamp-1">
